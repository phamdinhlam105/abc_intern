...
export default function Header({ title }: { title: string }) {
    ...
    return (
        <div className="flex h-16 items-center justify-between w-full border-b sticky top-0 bg-white z-10">
            ...
            <div className="ml-auto mr-4">
                <DropdownMenu >
                    ...
                    <DropdownMenuContent
                        ...
                        align="end"
                        sideOffset={2}
                        className="bg-white shadow-md max-w-60 p-2 rounded-md border">
                        ...
                        <DropdownMenuItem
                            ...
                            className="flex p-2 hover:bg-gray-100 hover:outline-none rounded-md">
                            <User />
                            Thông tin cá nhân
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
                        <DropdownMenuItem className="flex p-2 hover:bg-gray-100 hover:outline-none rounded-md">
                            <LogOut />
                            Đăng xuất
                        </DropdownMenuItem>
                    </DropdownMenuContent>
